...
import { getCurrentUser, createUserDocFromAuth, signInWithGooglePopup, signInAuthUserWithEmailAndPassword, createAuthUserWithEmailAndPassword, signOutUser, AdditionalInfo } from '../../utils/firebase/firebase.utils'
...
export function* signInAfterSighUp({ payload: { user, additionalDetails } }: SignUpSuccess) {
